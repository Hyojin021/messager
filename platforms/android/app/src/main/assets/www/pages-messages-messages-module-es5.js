...
var MessageComponent = /** @class */ (function (_super) {
    ...
    function MessageComponent(injector, navParams, authService, commonService, firestoreService, messageService, settingService) {
    ...
    MessageComponent.prototype.autoReply = function (text, images) {
        var _this = this;
        if (images === void 0) { images = null; }
        if (this.settingService.setting.autoReply === true) {
            setTimeout(function () {
                var data = {
                    ...
                    sendAt: Date.now(),
                    uid: _this.getSender(_this.message).uid
                };
                _this.loading = true;
                _this.messageService
                    .send(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, _this.message), data)
