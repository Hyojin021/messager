...
const COMPONENTS = [TabMenuComponent, NoDataComponent, SearchBarComponent, SpinnerComponent, SimpleItemComponent, RatingComponent];
const MODALS = [
...
const DIRECTIVES = [ImageLoaderDirective, ElasticDirective, ColorLuminanceDirective];
